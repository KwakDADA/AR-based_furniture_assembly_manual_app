...
public class Level6Controller : MonoBehaviour
{
    ...
    public void BumpNStop6(bool fit, GameObject ob) //6단계의 조립
    {
        if (!fit) //충돌 전
        {
    ...
    public void OnClickRe6()
    {
        ...
        framecount = false;
        isStart = false;
        GameObject.Find("start6").GetComponentInChildren<Text>().text = "start";
    }
    ...
    public void OnClickStart6()
    {
        ...
        {
            GameObject.Find("start6").GetComponentInChildren<Text>().text = "stop";
            isStart = true;
            move = true;
            Init = false;
            framecount = true;
